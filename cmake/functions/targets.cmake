...
# Add library
function(custom_add_library TARGET SOURCES LIBRARIES INCLUDES INSTALL VERSION_MAJOR VERSION_MINOR)
	...
	if(VERSION_MAJOR)
		...
		set_target_properties(${TARGET} PROPERTIES VERSION "${VERSION}" SOVERSION "${VERSION_MAJOR}")
	endif(VERSION_MAJOR)
	if(INSTALL)
		INSTALL( TARGETS ${TARGET} DESTINATION ${INSTALL} )
	endif(INSTALL)
